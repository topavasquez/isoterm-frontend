...
export default function CrearAire({ setOpen, crearAire, form, setForm, loadingForm }) {
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Crear Aire</h5>
                        <button
                            type="button"
                            className="btn-close"
                            aria-label="Close"
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-primary" onClick={crearAire}>
                            {loadingForm ?
