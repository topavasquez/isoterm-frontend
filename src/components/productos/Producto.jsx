  ...
  const handleAgregarAlCarrito = () => {
    if (producto) {
      ...
      const productoParaCarrito = {
        id: uniqueId,
        originalId: producto.id, // mantener el id original para referencia
        nombre: `${producto.marca} ${producto.modelo}`,
        descripcion: `${producto.btu} BTU`,
        precio: producto.precio,
        imagen: aire, // usando la imagen por defecto
      ...
      abrirCarrito(); // Abrir el carrito después de agregar
            ...
            <div className="card shadow-sm">
              <div className="card-body text-center">
                ...
                <p className="lead text-muted">
                  Aire acondicionado de {producto.btu} BTU con tecnología
                  avanzada
                </p>
              </div>
            </div>
